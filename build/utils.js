...
function chapterDrawerTemplate(){
    ...
    html +=                 '</svg>';
    html +=             '</li>';
    html +=             '<li class="zap-slideout-menu-item" v-for="book in bookChapters">';
...
module.exports = {addPlusSignToNormalLink, LeftArrow, RightArrow, AutoComplete, AutoCompleteResults, ChapterDrawer};